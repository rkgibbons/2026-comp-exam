...
\begin{itemize}[leftmargin=*, itemsep=4pt]
    ...
    \item \textbf{Federalism as a veto point}: Federal systems create multiple decision centers that can block or delay central government action. This is the federal-unitary dimension's expression of the consensus principle: territorial dispersion of power constrains majority rule in the same way that coalition cabinets and PR constrain it on the executives-parties dimension.
