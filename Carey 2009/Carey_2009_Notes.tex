...
\begin{itemize}[leftmargin=*, itemsep=4pt]
    ...
    \item Legislators face two primary principals (likely more): their voters can hold them accountable, especially if individualistic accountability is possible, and their party leadership can hold them accountable depending on the institutional strength of the party system. (A high-ranking third principal would be presidents because of their impact on legislative outcomes and processes). These principals may be sequential (i.e., voters $\rightarrow$ parties $\rightarrow$ legislator) or competing (i.e., voters $\rightarrow$ parties $\rightarrow$ legislator AND voters $\rightarrow$ legislator)
    \begin{center}
