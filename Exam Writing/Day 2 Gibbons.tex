...
In this response, I examine the primary factors determining whether or not social, political, and economic phenomena are most appropriately addressed through institutional constraints or non-institutional alternatives, and how these ``solutions'' come to exist. I further consider whether those constraints (when necessary) take the form of either formal or informal institutions, which I further define in the following section(s). The paper proceeds as follows. First, I discuss the primary purposes of institutions in facilitating cooperation, focusing largely on their impacts regarding transaction costs and their resultant equilibrium outcomes. Second, I explore the role played by repeated interactions, and discuss non-institutional stability under certain conditions of repetition (which themselves may be achieved by means of institutions). Third, I consider how existing incentive structures may (or may not) be already aligned with optimal outcomes, transitioning into a focus on the role of social norms (and their inclusion as informal institutions). I conclude by discussing the ever-present philosophical debate between rational-choice-focused ``new institutionalists'' and their interpretivism-focused dissenters, and consider how our framing of institutions might facilitate a reconciliatory (and intellectually productive) future between these two factions. \\
...
\section*{What Do Institutions ``Solve?''}
