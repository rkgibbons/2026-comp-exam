...
The most effective and enjoyable outcomes of political life inherently involve some degree of cooperation: there must be some means of compromise and common investment in order to achieve anything requiring more than one individual's construction. To progress from the Hobbesian state of nature to any semblance of organized life -- assuming, as we did yesterday, that the ``nasty, short, and brutish'' reality of this chaos is undesirable -- we must secure some degree of collaboration and collective agreements. It is no surprise, then, that a great deal of social science is devoted to identifying the conditions and factors under which this cooperation might be most effectively achieved. Political science in particular has taken an affinity to examining the antagonistic incentives which preclude this cooperation, and conversely, the role played by institutions in overcoming them. Yet, whether or not this institutional response is indeed the most appropriate solution to noncooperation is a core debate, and one largely without a clean or unilateral answer. 
...
In continuing our search for non-institutional cooperation, then, we must turn towards social behaviors, norms, and informal institutions. Informal institutions generally consist of those which are not explicitly recorded (at least in an official capacity) and for which sanctioning outcomes are primarily driven by social responses instead of structural consequences \cite{north1990}. Consider, for example, an individual living in a liberal democracy, who is engaged in a long-term relationship but is \emph{not} married. That individual's decision to commit infidelity against their partner may very likely come with social ostracization; if their (presumably now former) partner or their acquaintances held some position of authority, such as hiring for a job, those opportunities may become restricted; yet, in the absence of other extraordinary factors, their act of disloyalty itself does not result in any officially-mandated consequence. Rather, their respite is driven by the choices of community members, individually and collectively. That being said, the same act committed under slightly different circumstances -- suppose the individuals were legally married, or were living in a socially conservative nation where any such behavior could be illegal -- could be governed instead primarily by formal institutions. 

This same logic could suggest some alternatives to formal institutional intervention in facilitating cooperation. For example, most societies have some general expectations for behavior in public spaces; there is an expectation of silence in a theater, with electronic devices silenced and attendees in presentable outfits. Yet, in considering this, we begin to see a deviation: while refraining from talking or using electronic devices during the performance are generally established policies, with flagrant violators being removed from the show, the ``official'' dress code may be much simpler. The Broadway in Chicago code of conduct\footnote{https://www.broadwayinchicago.com/terms/} specifically prohibits mobile device usage during shows or other ``disruptive behavior,'' but while assuredly some marginal cohort has been removed from the theater because of disruptive clothing, those in t-shirts are much more likely to receive unfriendly stares from fellow patrons than they are to be removed outright. More broadly: the observed behavioral outcomes in this environment are a \emph{combination} of influences from formal and informal institutions, and while the lack of formalization of some policies may indeed allow for a degree of noncompliance, theater ettiquette is (also relatively) well-maintained regardless.

What might this suggest about constructing cooperative institutions in a political framework? Certainly, we might suggest that certain constructive outcomes can be achieved merely through informal institutions; there are many well-funded and highly-effective religious charities whose funding is largely derived from practitioners' collective expectation of contributing. Yet, to extend this as a possibility for \emph{all} cooperative outcomes is undoubtedly a stretch. For example, as much as these charities may meaningfully contribute to marginalized members of society, a huge proportion of welfare spending in the developed world is still state-sponsored and tax-funded. Some of this can likely be attributed to size, in line with Olson's \citeyear{olson1965} discussion of free-riding growing with group magnitude: a community's ability to sponsor new school equipment through contributions may be achievable under purely social influences, but the city of Chicago's ability to fund their schools in such a way is extremely limited.\footnote{Granted, they seem to just send funds to the CTU anyways, so maybe a long-shot option wouldn't hurt.} Another consideration may simply be community salience and collective emotional investment: an elementary school in a very young neighborhood will likely garner more contributions (controlled for wealth) than in a retirement community. 

The impact of informal institutions and social norms on cooperative behavior serves as a ``moderating'' factor within this discussion as a whole. It broadly serves as evidence that \emph{some} cooperation can be achieved in the absence of formal institutional constraints. Yet, their role is best positioned as a contributing factor in establishing cooperation \emph{alongside} formal institutions \cite{helmkelevitsky2006,stokes2006}. It is precisely this relationship that Ostrom \citeyear{ostrom1990} explores, in considering common-pool-resource governance within various communities. Ostrom's empirical investigation (largely based in fishing communities, as well as water allocation in the Western United States), coupled with her theoretical conclusions, suggest instead that effective and sustainable cooperation is most achievable precisely when formal \emph{and} informal institutions act in complementary manners. Broadly, this entails constructing such institutions at the local or community level, and ensuring that the community retains broad oversight of those institutions. A similar perspective is presented in Selznick's \citeyear{selznick1949} examination of the early years of the Tennessee Valley Authority. As Selznick argues, the sweeping institution's success was in large part driven by its effort to adapt to existing local decision-making institutions (and reserve cooptation or coercion for when necessary). Both of these frameworks not only cements the aforementioned self-enforcement mechanism, but further maximize the likelihood of achieving cooperation through informal institutions \emph{when possible}, and formal institutions \emph{when necessary}. 

However, institutional theorists have further warned that this alignment between formal and informal institutions may be challenging to come by. One of the core traits of institutions in general -- both formal and informal -- is their resistance to drastic change. In formal institutions, this often takes the form of path dependency. Pierson \citeyear{pierson2000}, for example, highlights how institutions tend to deliver increasing returns, and become more effective as they mature. Stigler \& Becker \citeyear{stiglerbecker1990} provide a similar, albeit less-poetic, insight: norms are ``sticky.'' Though this may indeed be socially productive if the institution continues to effectively meet the need it was created for (or at least, some salient need), it can dissuade decision-makers from making significant adjustments to already-established institutions, even if meaningful improvements could be possible or necessary. Yet, perhaps no characterization of institutional resistance to change is as impactful as Ellickson's \citeyear{ellickson1985} discussion of cattle-vehicular collisions in central California. Ellickson explores an extensive period of political development within rural Shasta County that ultimately includes the emergence of broader insurance companies and more extensive liability and negligence laws -- yet, as he finds, despite this significant evolution in formal institutions, the ranchers themselves (who generally either owned the fallen cow or the car which downed it) were much slower to diverge from their traditional liability arrangements. Initially, this was no cause for concern, and in fact provided an epitomic example of extra-institutional cooperation: operating on common understandings of liability, the ranchers largely settled collision expenses amongst themselves. This became a more significant problem as an increase in long-distance travelers resulted in collisions with those from outside the community; it was the ``outsiders" who began to win collision cases which went to court, even as those cases conflicted with the ranchers' expectations. Needless to say, the inherent difficulty of transforming cultural beliefs and subsequently informal institutions can preempt cooperation when \emph{some} individual preferences -- or the formal institutional environment as a whole -- begin to change.


\section*{Framing Norms and Institutional Perspectives}

There is one more debate this exploration invokes: how do we conceptualize informal institutions versus social norms or other cultural influences? The entire discussion of informal institutions as an alternative to institutional constraints already implies the assumption that information institutions are not, in fact, institutional; is it even reasonable to portray such socially-constructed outcomes as non-institutional? 

I close this section -- and this exam -- by discussing how we might properly account for such influences in the rationalistic framework that modern institutional theory is largely built upon \cite{cooklevi1990,north1990a}. The general contestation against rationalism and institutionalism is quite vividly expressed by Geertz \citeyear{geertz1973}, who in his defense of interpretivism posits rationalist frameworks as overly-simplifying complex sociocultural phenomena. Geertz decries efforts to explain sweeping societal events as the outcomes of rational incentive structures, suggesting that to do so would necessarily overlook some myriad of emotional influences and cultural norms. Under this perception, the above characterizations of informal behavioral factors would most appropriately be cleanly separated from general constructions of ``institutions,'' and instead lend themselves towards a more anthropological framework.

The rational choice literature -- or at least, its more reasonable proponents -- in fact frequently agrees with Geertz's overarching concern of aggressive simplification. Cook and Levi \citeyear{cooklevi1990} open their book with an acknowledgement of the tendencies of some corners of rational choice theory to try and encompass complex -- and very human -- factors in logical and mathematical environments; indeed, as they argue, the economic principles upon which rational choice frameworks were first constructed are not always relevant in interpersonal (and non-marketplace) interactions. Yet, they contend, the ongoing efforts of 'responsible' rational choice theorists to (1) more appropriately limit their scopes and (2) more effectively account for human factors in behavioral deviations possess quite a significant potential for meaningful social science theory-building and discovery. To summarily dismiss rational choice on the grounds of the presence of some emotional involvement, then, can be quickly characterized as an unproductive response itself.

As a first consideration, rational choice models can, in fact, accommodate norms and informal institutions, \emph{to an extent}. Quite a bit of progress has been made in behavioral economics to more appropriately represent these influences, while similar progress in institutional organization has better accounted for their inclusion. A common modeling approach when encountering social norms, for example, is to simply envelop the impacts of these norms within a utility function. Given the presence of an exogenously-existing norm, this is quite straightforward to model, and a rationalist framework would generally simply apply a cost term penalizing the player from a deviation from the norm. Even without a given pre-existing norm, we can absolutely model equilibria whereby actors are incentivized to act ``in line'' with their counterparts, simply by applying the cost with respect to distance from the mean, or weighted mean, or median, or whatever salient value is most appropriate for that given social interaction. Of course, this requires care and responsibility, and summarily deciding the structure of various costs from norm deviation is but a shortcut: formal theorists often use quadratic loss to preserve differentiability, but an interpretivist investigation of a given norm may lend that the loss function is not even convex, let alone quadratic. But this is not to say that rational choice \emph{should not} be employed in evaluating institutions; rather it is to qualify its use with caution and care.

A second consideration transcends concerns about accurately reflecting humanistic tendencies within rational models by considering comparative statics as the salient outcomes, rather than equilibrium conditions. Even in cases where Geertz would be well within his rights to posit that a rational model wrongfully oversimplifies the factors behind an individual's decisions within society, it is not necessarily the outcome decision itself that we are seeking to recover; rather, a great deal of rational modeling instead focuses on the comparative statics of various conditions and outcomes. Given a formal institutional influence $A$ and an informal institutional or norm influence $B$, we may not be able to accurately model some function $f(A,B)$ returning an expected outcome -- but, we absolutely may recover $\frac{\partial f(A,B)}{\partial A}$ or $\frac{\partial f(A,B)}{\partial B}$, and gleam meaningful information about the relative influence of either $A$ or $B$. The trouble is not with the merits of rationalism itself, but with the overzealous efforts to quickly apply it to more complex social science phenomena.

This, ultimately, is at the heart of best incorporating norms and rationalism under one umbrella, and reconciling the struggle between institutional and extra-institutional alternatives in the pursuit for sustained cooperative outcomes. To consider one without the other, either as an academic or as a designer of institutions, would be at best to work with one hand tied and at worst to work with both hands against each other. Institutions and non-institutions both provide cooperation in some cases, and fail to provide it in others; similarly, just as there exist contexts best served by formal institutional solutions, there exist circumstances where a less formal approach would be most effective. Perhaps we can justify purely institutional solutions by encompassing as many norms and social influences as possible under the definition of ``informal institutions,'' but if in doing so we neglect the humans who will ultimately operate and live under this framework, then we are no closer to an effective outcome than we were before. Similarly, perhaps, we can reject rational institutionalism as an affront to humanity, but we then close the door to a broad range of scientific and theoretical progress that may indeed advance our understanding of cooperation and collective life. In chasing absolutism as scholars, we will inevitably fall short of the best answers available, and if our role in the social sciences is to indeed improve the quality of social life, then it is not only an intellectual but a moral obligation to incorporate these varying perspectives to the greatest extent possible.
